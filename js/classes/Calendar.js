    ...
    static _getBalanceRowCode()
    {
        return '<tr>' +
                '<tr class="month-total-row">' +
                    ...
                    `<td class="month-total-text" title="${i18n.t('$Calendar.working-days-left')}">${i18n.t('$Calendar.working-days')}</td>` +
                    `<td class="month-total-time" title="${i18n.t('$Calendar.working-days-left')}"><input type="text"  id="month-working-days" size="5" disabled></td>` +
