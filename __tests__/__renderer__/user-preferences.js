...
describe('User Preferences save/load', () => {
    ...
    const testPreferences = {
        'close-to-tray': false,
        'hide-non-working-days': true,
        'hours-per-day': '22:22',
        'notification': 'enabled',
        'start-at-login': true,
        'theme': 'dark',
        'update-remind-me-after' : '2020-01-01',
        'working-days-monday': false,
        'working-days-tuesday': false,
        'working-days-wednesday': false,
        'working-days-thursday': false,
        'working-days-friday': false,
        'working-days-saturday': true,
