...
} = require("./src/configs/i18next.config.js");
...
function checkIdleAndNotify() {
    if (recommendPunchIn) {
        ...
        createNotification(
            getCurrentTranslation("$Notification.punch-reminder")
        ).show();
    }
}
